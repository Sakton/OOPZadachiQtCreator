...
int main()
{
    ...
    DatePublic dt3( "20.09.2020" );
    std::cout << dt3.Interval( dt2 ) << std::endl;

    // ПРОГРАММА ПРОТЕСТИРОВАНА СТО ТЫЩ РАЗ!!ПОКА ДЕЛАЛАСЬ
    std::cout << "************ DatePrivate ***************" << std::endl;
    DatePrivate pdt2( "21.10.2020" );
    DatePrivate pdt3( "20.09.2020" );
    std::cout << pdt3.Interval( pdt2 ) << std::endl;
}
