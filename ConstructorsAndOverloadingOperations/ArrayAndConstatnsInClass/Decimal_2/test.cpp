...
// ASSERT_EQ(ожидаемое, реальное); — проверка, что реальное значение точно равно
// ожидаемой величине ASSERT_NE(ожидаемое, реальное); — проверка, что реальное
// значение не равно ожидаемой величине ASSERT_LT(ожидаемое, реальное); —
// проверка, что ожидаемое значение < реальная величина ASSERT_LE(ожидаемое,
// реальное); — проверка, что ожидаемое значение <= реальная величина
// ASSERT_GT(ожидаемое, реальное); — проверка, что ожидаемое значение > реальная
// величина ASSERT_GE(ожидаемое, реальное); — проверка, что ожидаемое значение >=
// реальная величина
//*/
