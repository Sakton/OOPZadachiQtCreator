...
/*
WARNING: эти задачи решаются просто через перегрузку оператора индексирования
сперва оператор, потом обьект можно рассматривать как просто массив со своими
фишками
