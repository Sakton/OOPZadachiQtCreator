...
const BitString & BitString::operator |= ( const BitString & other ) {
	...
	for ( int i = count - 1, j = other.count - 1; i >= 0 && j >= 0; --i, --j ) {
		bitStr [ i ] = ( bitStr [ i ] == '1' || other.bitStr [ j ] == '1' ) ? '1' : '0';
	}
	return *this;
}
...
const BitString & BitString::operator ^= ( const BitString & other ) {
	for ( int i = count - 1, j = other.count - 1; i >= 0 && j >= 0; --i, --j ) {
		bool pr = ( bitStr [ i ] == '0' && other.bitStr [ j ] == '1' ) || ( bitStr [ i ] == '1' && other.bitStr [ j ] == '0' );
		bitStr [ i ] = ( ( bitStr [ i ] == '0' && other.bitStr [ j ] == '1' ) || ( bitStr [ i ] == '1' && other.bitStr [ j ] == '0' ) ) ? '1' : '0';
	}
	return *this;
}
